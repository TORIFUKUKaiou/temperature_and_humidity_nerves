defmodule TemperatureAndHumidityNerves.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: TemperatureAndHumidityNerves.Supervisor]
  ...
  def children(_target) do
    [
      ...
      # Starts a worker by calling: TemperatureAndHumidityNerves.Worker.start_link(arg)
      # {TemperatureAndHumidityNerves.Worker, arg},
      TemperatureAndHumidityNerves.Ticker
    ]
  end

  def target() do
    Application.get_env(:temperature_and_humidity_nerves, :target)
  end
end
